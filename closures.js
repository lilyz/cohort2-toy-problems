...
var pingPongTracker=function(){
	...
	obj.myLevel=function(){
		if (count<1800) {return "I need to improve my game";}
		if (count>1800 && count<6000) {return "You need to improve your game"}
		if (count>6000) {return "Wow, I have wasted a lot of time"}
