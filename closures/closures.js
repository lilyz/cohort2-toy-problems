...
var pingPongTracker = function(){
  //By declaring time outside of the returned object, you keep it private and inaccessible.
  //Nobody can directly change time, only through methods
  var time = 0;
  return {
    ...
    myLevel: function(){
      return time<30 ? 'I need to improve my game' : time<100 ? 'You need to improve your game' : 'I have waster a lot of time';
    }
  }
};
