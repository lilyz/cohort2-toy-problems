...
var maximumProfit  = function(array) {
	...
	var profit = 0;
	if (array.indexOf(getMinOfArray(array)) === array.length-1) {
		return profit;
	} else {
	newArr = array.slice(array.indexOf(getMinOfArray(array)))
	profit = getMaxOfArray(newArr) - getMinOfArray(array);
	}
	return profit;
}